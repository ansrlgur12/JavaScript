...
// slice() : 시작 위치와 종료 위치를 주면 문자열에서 해당 부분을
// 잘라내서 반환
let str = "Apple, Banana, Kiwi";
let res = str.slice(7,-1);
console.log(res);

// substring() : 시작 위치와 종료 위치를 주면 문자열에서 해당 부분을 
// 잘라내서 반환
let str2 = "Apple, Banana, Kiwi";
let res2 = str.substring(9, -1);
console.log(res2);
...
// 기존의 문자열을 변경하지 않고 합쳐진 새로운 문자열을 생성 (불변성)
let text1 = "Hello";
let text2 = "World";
...
let str11 = "55";
//str11 = str11.padStart(4, 0); // 총 길이, 자리가 비는 경우 0으로 채움
//console.log(str11);

str11 = str11.padEnd(4, 0); // 총 길이, 자리가 비는 경우 0으로 채움
console.log(str11);
